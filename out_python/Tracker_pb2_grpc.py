...
class TrackerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPosition = channel.unary_unary(
                '/real.grpc.tracker.Tracker/GetPosition',
        ...
        self.GetAllRobots = channel.unary_unary(
                '/real.grpc.tracker.Tracker/GetAllRobots',
...
def add_TrackerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetPosition': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=Tracker__pb2.Robot.FromString,
                    response_serializer=Tracker__pb2.Position.SerializeToString,
            ),
            'GetAllRobots': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAllRobots,
                    request_deserializer=Tracker__pb2.Empty.FromString,
                    response_serializer=Tracker__pb2.RobotList.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'real.grpc.tracker.Tracker', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('real.grpc.tracker.Tracker', rpc_method_handlers)
